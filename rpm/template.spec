...
Name:           ros-rolling-rosbag2-performance-writer-benchmarking
Version:        0.5.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS rosbag2_performance_writer_benchmarking package
...
%description
Code to benchmark the part of rosbag2 which starts after the callback is
received
...
%changelog
* Wed Apr 06 2022 Karsten Knese <karsten@openrobotics.org> - 0.5.0-1
